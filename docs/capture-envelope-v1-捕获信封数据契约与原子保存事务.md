...
4. C5A `63a3250`、C5B `ab2a613`、C5V `a9913e2`、C6A `84ee1d7`、C6B `f686941` 与 C6C `ea8f84e` 已于 2026-09-18 同步至 `origin/main`，Windows CI 运行 `35319645501` 首次通过。下一功能门禁为需单独授权的 C7 受限 CLI；上述阶段均不接 GBrain。
