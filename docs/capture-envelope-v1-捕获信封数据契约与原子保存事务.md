...
4. C4V `1e38f2f`、C5-0 `ea530ad` 与最小 Windows CI `c4d2c7b` 已同步至 `origin/main`，首次远端 Windows CI 已通过。下一功能门禁为仍需另行授权的 C5A，之后按 C5A/C5B/C5V、C6 逐批验收追加、迁移和业务事务崩溃恢复。上述阶段均不接 GBrain。
