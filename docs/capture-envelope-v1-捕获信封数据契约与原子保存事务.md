...
> 边界：本文定义完整数据和事务契约；四个公开操作及 C6A–C6C 已实现，C7–C8 及本文其余远期能力尚未完成
...
4. C4V `1e38f2f`、C5-0 `ea530ad` 与最小 Windows CI `c4d2c7b` 已同步至 `origin/main`，首次远端 Windows CI 已通过；C5A `63a3250`、C5B `ab2a613`、C5V、C6A `84ee1d7`、C6B `f686941` 与 C6C 均为尚未 push 的独立本地批次。下一功能门禁为需单独授权的 C7 受限 CLI；上述阶段均不接 GBrain。
