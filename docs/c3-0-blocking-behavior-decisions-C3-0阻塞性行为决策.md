...
> 状态：Approved Design；六项决策已人工确认，但尚未实现，不是 Effective 规范<br>
> 整理日期：2026-09-08<br>
> 确认日期：2026-09-08<br>
...
C3 完成条件包含版本、Envelope、事件、投影和回执，但当前只有 `capture.yaml` 示例，没有可直接实现的 State Event schema，也没有明确哪些投影字段在 C3 固定。
