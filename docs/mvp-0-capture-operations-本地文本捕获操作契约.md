...
> C7-0 CLI 适配映射确认日期：2026-09-21；C7A 私有协议层完成并独立版本化日期：2026-09-22（尚未 push）<br>
> 适用范围：单机、单用户、纯文本捕获<br>
> 边界：本文定义调用方可见的四个日常文本操作及 C7 CLI 的一对一适配边界；C6A 不增加公开参数，C6B/C6C 的显式管理操作与四操作分离；C7A 只完成私有协议层，C7B–C8、生产目录和外部接入仍未完成
